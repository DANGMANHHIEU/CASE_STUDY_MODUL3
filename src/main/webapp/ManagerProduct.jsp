        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="home"><h2>Trưa nay <b>ăn gì ???</b></h2></a>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} VND</td>
                                <td>
                                    <a href="loadProductEdit?ProducID=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Sửa">&#xE254;</i></a>
