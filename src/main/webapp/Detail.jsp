                            ...
                            <article class="card-body p-5">
                                ...
                                <p class="price-detail-wrap">
                                            <span class="price h3 text-warning">
                                                <span class="currency">${detail.price}</span><span
                                                    class="num">VND</span>
                                            </span>
                                    <!--<span>/per kg</span>-->
                                </p> <!-- price-detail-wrap .// -->
                                <dl class="item-property">
                                    <dt>Mô tả Của Sản Phẩm</dt>
...
<%--                                <a href="#" class="btn btn-lg btn-primary text-uppercase"> Mua </a>--%>
                                <a href="add-to-cart?id=${detail.id}" class="btn btn-lg btn-outline-primary text-uppercase"> <i
