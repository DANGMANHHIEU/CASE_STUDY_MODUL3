...
public class DAO {
    ...
    //    public void order(String name, String phone, String total_price, String vat, String total_payment) throws ClassNotFoundException {
//        String sql = "INSERT INTO order (name, phone, total_price, vat, total_payment, dateTime) VALUES (?, ?, ?, ?, ?, ?);";
//        try {
//            connection = new DBContext().getConnection();
//            preparedStatement = connection.prepareStatement(sql);
//            preparedStatement.setString(1, name);
...
//            preparedStatement.setString(5, total_payment);
...
//    }
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        DAO dao = new DAO();
        List<Product> cart = dao.getAllProduct();

        String name = "hà Văn dũng";
        String phone = "03825646256";
        String totalPrice = "34.95";
        String vat = "5.00";
        String totalPayment = "39.95";
